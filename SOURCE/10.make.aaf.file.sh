...
pathSplit="$DIROUT"/"$PREFIX".chr${x}"$SUFFIX"
...
cat "${pathTmp}"above.1perc.chr* "${pathTmp}"deleterious.below.0.1perc* "${pathTmp}"deleterious.0.1.to.1perc* > "${pathReg}"regenie.aaf.file.txt
