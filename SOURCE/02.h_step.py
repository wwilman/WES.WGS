...
pathQC = os.environ['outputHAIL']



#import the data and sample QC
hl.import_vcf(pathNorm, min_partitions=4, reference_genome='GRCh38', array_elements_required = False, force_bgz=True).write(pathMT, overwrite=True)
...
mtAll = mtAll.filter_cols((mtAll.sample_qc.call_rate >= 0.90) & (mtAll.sample_qc.dp_stats.mean >= 20))
